...
We have removed our interpretation of this result form this section. This statement is now paraphrased in the Discussion at line \lineref{mov1}
...
This question was shared by both reviewers and the editor. We have addressed this question by providing a new figure demonstrating high degrees of overlap in patterns of occurrence among these species, and analyses of plant community data indicating the frequently interaction (lines \lineref{occ1}-\lineref{occ2}. These changes have been detailed more fully above in the responses to the editor's comments.
...
We have made this change in line \lineref{tiny3}.
...
First, we have changed the "Focal species" sub-section of out methods to be "Species selection" and more comprehensively laid out our criteria for choosing species in lines \lineref{crit1}-\lineref{crit2}.
