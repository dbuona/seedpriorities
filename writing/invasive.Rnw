...
%work on below
\item \textit{Synthesis and applications.} This study revealed that the mechanistic link between germination phenology of invasive plants and their competitive success can be strongly mediated by sensitivity differences to climatic variation between introduced and natives species. Warming conditions will likely exacerbate these differences, increasing the seasonal priority effects that rapidly germinating species 

manage for early phenolgoy and inlucde in restoration stock

revealed a mechanistic link between environmental variation, germination phenology and competition, suggesting that climate-change mediated phenological shifts will re-organize patterns of species interactions in the decades to come. Through leveraging unique species-level responses to environmental change, our experiments constrained the magnitude of variation in phenological differences among competitors to biological realistic scenarios and allowed us to robustly estimate seasonal priority effects on plant competition in a way that is readily translatable to climate change forecasting. O
\end{enumerate}
%319 words
