...
\title{Seedling competition with %Honewort (\textit{Cryptotaenia canadensis}) 
 an invasive %Dame's Rocket (\textit{Hesperis matronalis}) 
...
Special thanks to K.J Woodruff, L. Toomey and the rest of the Arnold Arboretum research greenhouses staff for helping to manage the growth facilities and maintain these experiments. %EMWAug2022: Could be a chance mention Covid? Such as '...maintain and repeat these experiments throughout Covid-related challenges.'
